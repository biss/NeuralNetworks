...
num_hidden_nodes_1 = 80
num_hidden_nodes_2 = 50
num_output_nodes = 10
...
weights = {
    'hidden_1': tf.Variable(tf.random_normal([num_input_nodes, num_hidden_nodes_1])),
    'hidden_2': tf.Variable(tf.random_normal([num_hidden_nodes_1, num_hidden_nodes_2])),
    'output': tf.Variable(tf.random_normal([num_hidden_nodes_2, num_output_nodes]))
}

biases = {
    'hidden_1': tf.Variable(tf.random_normal([num_hidden_nodes_1])),
    'hidden_2': tf.Variable(tf.random_normal([num_hidden_nodes_2])),
